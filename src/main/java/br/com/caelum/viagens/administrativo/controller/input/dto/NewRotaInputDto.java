package br.com.caelum.viagens.administrativo.controller.input.dto;
...
public class NewRotaInputDto {
	...
	public Rota toModel(AeroportoRepository aeroportoRepository) {
		...
		return new Rota(processaNome(aeroportoOrigem, aeroportoDestino), aeroportoOrigem.get(), 
				aeroportoDestino.get(), this.duracao);
	}
